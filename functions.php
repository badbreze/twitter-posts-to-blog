...
function dg_tw_schedule($schedules)
{
    $schedules['dg_tw_oneminute'] = array(
        'interval' => 60,
        'display' => __('Once Every Minute', 'twitter-posts-to-blog')
    );

    $schedules['dg_tw_fiveminutes'] = array(
        'interval' => 300,
        'display' => __('Once Every 5 Minutes', 'twitter-posts-to-blog')
    );

    $schedules['dg_tw_tenminutes'] = array(
        'interval' => 600,
        'display' => __('Once Every 10 Minutes', 'twitter-posts-to-blog')
    );

    $schedules['dg_tw_twentynminutes'] = array(
        'interval' => 1200,
        'display' => __('Once Every 20 Minutes', 'twitter-posts-to-blog')
    );

    $schedules['dg_tw_twicehourly'] = array(
        'interval' => 1800,
        'display' => __('Once Every 30 Minutes', 'twitter-posts-to-blog')
    );

    $schedules['dg_tw_weekly'] = array(
        'interval' => 604800,
        'display' => __('Once Every 7 Days', 'twitter-posts-to-blog')
    );

    $schedules['dg_tw_bi_weekly'] = array(
        'interval' => 1209600,
        'display' => __('Once Every 14 Days', 'twitter-posts-to-blog')
    );

    $schedules['dg_tw_monthly'] = array(
        'interval' => 2592000,
        'display' => __('Once Every 30 Days', 'twitter-posts-to-blog')
    );
...
function dg_add_menu_item()
{
    ...
    add_menu_page(__('Twitter To WP', 'twitter-posts-to-blog'), __('Twitter To WP', 'twitter-posts-to-blog'), $privilege['privileges'], 'dg_tw_admin_menu', 'dg_tw_drawpage', '', NULL);
...
function dg_tw_activation()
{
    ...
    if (!$dg_tw_ft) {
        update_option('dg_tw_ft', array(
            ...
            'ipp' => 25,
            'author' => 0,
            'title_format' => __('Tweet from %author%', 'twitter-posts-to-blog'),
